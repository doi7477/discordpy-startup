...
#ようこそ文
strtmp = "# 自己紹介場 で自己紹介していただければ大変助かりますのでご協力お願いします\r\n"\
         ":large_blue_diamond: 基本ルール:large_blue_diamond: \r\n"\
         ":one: *遠征は12時、20時 ギルドチャットへお声掛けください。*\r\n"\
         ":two: *要塞は21時から模擬場入ります。本戦から参加する際は連絡があるまで待機でお願いします。*\r\n"\
         ":three: *バンケットは21時半からです。*\r\n"\
         ":four:*カオスorハードヒルラは基本的には22時からです。*\r\n"\
         ":five:*カオスアビスは毎週木曜日22時からです。(ヒルラはその後)*\r\n"\
         "何かご不明な点があれば Chino、 怪盗どんちゃ、 リリナスまでいつでもご連絡ください。\r\n"\
